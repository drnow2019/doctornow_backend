...
<body class="">
    <div class="page-wrapper">
        ...
        <div class="page-container">
							...
							<div class="row">
                                ...
                                <!-- DATA TABLE-->
										<div class="card-body">
											...
											<div class="card">
                                    <form action="<?= base_url('promocode/editpromo') ?>" method="post"  class="form-horizontal" id="myForm">
                                    <div class="card-body card-block">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="promo_code" name="promo_code" placeholder="Enter User Name" class="form-control" data-validation="required" value="<?= $promocode[0]->promo_code ?>"> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="hidden" name="promo_id" value="<?= $promocode[0]->id?>">
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="validity" name="validity" placeholder="" class="form-control datepicker" data-validation="required" value="<?= date('d-m-Y',strtotime($promocode[0]->validity)) ?>"> 
                                                </div>
                                            </div>
           ...
           <!--                                     </div>-->
           <!--                                     <div class="col-12 col-md-9">-->
           <!--                                         <input type="text" id="location" name="location" placeholder="Enter Location" class="form-control" data-validation="required" value="<?= $promocode[0]->location ?>"> -->
           <!--                                     </div>-->
           <!--                                 </div>-->
