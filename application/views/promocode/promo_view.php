                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="overview-wrap">
                                <h2 class="title-1">Promo Code  Management</h2>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="searchbox">
                                        ...
                                        <a href="<?php echo base_url('promocode');?>" class="btn "><i class="fa fa-refresh" aria-hidden="true"></i></a>
                                    </div>
                                </div>

                                <div class="col-md-6 col-xs-12">
                                    <div class="Add_Button">
                                        <a href="<?= base_url('promocode/add')?>"><i class="zmdi zmdi-plus"></i>Add New Offer</a>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="table-responsive m-b-40">
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody id="postList">
                                                        ...
                                                        <?php $this->load->view('promocode/promo_in'); ?>
                                                    </tbody>
                                                </table>
