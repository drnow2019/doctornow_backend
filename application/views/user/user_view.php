                          ...
                          <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="searchbox">
                                  ...
                                  <a href="<?php echo base_url('user');?>" class="btn "><i class="fa fa-refresh" aria-hidden="true"></i></a>
                              </div>
                            </div>

                            <div class="col-md-6 col-xs-12">
                                <div class="Add_Button">
                                    <a href="<?= base_url('user/add')?>"> <i class="zmdi zmdi-plus"></i>Add New User</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="table-responsive m-b-40">
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody id="postList">
                                                        ...
                                                        <?php $this->load->view('user/user_in'); ?>
                                                    </tbody>
