                    ...
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                        	...
                        	<div class="overview-wrap">
                                <h2 class="title-1">Speciality Management</h2>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="searchbox">
                                        ...
                                        <a href="<?php echo base_url('speciality');?>" class="btn "><i class="fa fa-refresh" aria-hidden="true"></i></a>
                                    </div>
                                </div>

                                <div class="col-md-6 col-xs-12">
                                    <div class="Add_Button">
                                        <a href="<?= base_url('speciality/add')?>" > <i class="zmdi zmdi-plus"></i>Add New Speciality</a>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <table class="table table-borderless table-data3">
                                                    ...
                                                    <tbody>
                                                        <tbody id="postList">
                                                            ...
                                                            <?php $this->load->view('speciality/speciality_in'); ?>
                                                        </tbody>
                                                </table>
                                            </div>
                                            <!-- END DATA TABLE-->
...
<script>
    function searchFilter(page_num, cur_page) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?=base_url('speciality/ajaxPaginationData')?>/' + page_num,
            ...
            success: function(html) {
                // alert(html);exit();
                $('#postList').html(html);
                window.history.pushState("object or string", "Title", "<?=base_url('speciality?')?>" + dataVar);
