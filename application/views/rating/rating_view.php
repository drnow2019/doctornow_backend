        ...
        <div class="page-container">
			...
			<div id="usermgnt" class="tabcontent">
				<div class="main-content">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="overview-wrap"> 
										<h2 class="title-1">Rating Management</h2>
                  ...
                  <button id="btnSearch"  class="btn btn search" onclick="searchFilter()"><i class="icon-search"></i> Search</button><a href="<?php echo base_url('rating');?>" class="btn "><i class="fa fa-refresh" aria-hidden="true"></i></a>
              </div>
              </div>
                                ...
                                <!-- DATA TABLE-->
										<div class="table-responsive m-b-40">
											...
											<tbody id="postList">                        
                                                ...
                                                <?php $this->load->view('rating/rating_in'); ?>
                                           </tbody>
...
<script>
    function searchFilter(page_num,cur_page) {
     ...
     // var type       = $('#type').val();
      ...
      $.ajax({
        type: 'GET',
        url: '<?=base_url('rating/ajaxPaginationData')?>/'+page_num,
        ...
        success: function (html) {
           // alert(html);exit();
          $('#postList').html(html);
            window.history.pushState("object or string", "Title", "<?=base_url('rating?')?>"+dataVar);
    ...
    t = {
        ...
        _listen: function() {
            var a = this,
                ...
                l = a.$clear,
                s = a.events;
            return t.handler(i, "touchstart touchmove touchend", e.proxy(s.initTouch, a)), n
        },
