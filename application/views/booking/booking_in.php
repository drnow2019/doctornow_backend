												...
												// echo"<pre>";print_r($booking);die;
                                                 ...
                                                 if(!empty($booking)) :
                                                 	foreach($booking as $values) :
                                                 	 //   echo"<pre>";
                                                 	 //   print_r($values);
                                           // $bookingReq   = $this->my_model->coutrow(BOOKING,"id",array('user_id'=>$values->user_id,'booking_type'=>'home'));    
												...
												?>
													<tr id="<?= $values->id ?>">
														...
														<td><?= $values->email ?></td>
														<td><?= $values->mobile ?></td>
														<?php if($values->booking_type=="scheduling"){?>
													    <td><?= date('d-m-Y',strtotime($values->schedule_date)) ?></td>
													    <td><?= date('h:i A',strtotime($values->schedule_time)) ?></td>
													...
													<td><a href="<?= base_url('homebooking/details/'.$values->booking_id)?>" class="item" title="view bookings">
