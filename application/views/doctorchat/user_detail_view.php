                                        ...
                                        <div class="col-12 col-md-12">
                                             ...
                                             <input type="hidden" name="" value="<?= $user_id ?>" id="myid">
                                              <input type="hidden" name="" value="<?= $user_id ?>" id="userid<?= $user_id ?>">
                                                <button type="button" class="btn btn-primary btn-sm"  onclick="myfunction(this.id)" id="<?= $user_id ?>">
...
//$(document).ready(function(){
  ...
  function load_data(userid)
  {
   // alert(userid);
    $.ajax({
      url:"<?php echo base_url('doctorchat/userDetails1'); ?>",
    //  dataType:"JSON",
 ...
 function myfunction(id) {
      ...
      $.ajax({
          url:"<?php echo base_url('doctorchat/saveData'); ?>",
          method:"POST",
          async: true,
          data:{
                  text:text,
...
//});
     ...
     function test()
  {
     $("#hide_search_id").css("display", "none");
      ...
      //alert();
        $.ajax({
          url:"<?php echo base_url('doctorchat/getuser'); ?>",
          method:"POST",
          async: true,
          data:{
