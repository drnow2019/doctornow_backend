							...
							<div class="row">
								<div class="col-md-12">
									<div class="overview-wrap"> 
										<h2 class="title-1">Payment Management</h2>
                  ...
                  <button id="btnSearch"  class="btn btn search" onclick="searchFilter()"><i class="icon-search"></i> Search</button><a href="<?php echo base_url('payment');?>" class="btn "><i class="fa fa-refresh" aria-hidden="true"></i></a>
                            ...
                            <th>Payment Mode</th>
                                        ...
                                        <tbody id="postList">                        
                                                ...
                                                <?php $this->load->view('payment/payment_in'); ?>
                                           </tbody>
...
<script>
    function searchFilter(page_num,cur_page) {
     ...
     // var type       = $('#type').val();
      ...
      $.ajax({
        type: 'GET',
        url: '<?=base_url('payment/ajaxPaginationData')?>/'+page_num,
        ...
        success: function (html) {
           // alert(html);exit();
          $('#postList').html(html);
            window.history.pushState("object or string", "Title", "<?=base_url('payment?')?>"+dataVar);
